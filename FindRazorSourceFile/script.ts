...
const razorSourceMap: { [key: string]: string | undefined } = {};
...
function overlay_onMouseMove(ev: MouseEvent): void {
...
function displayTargetMask(target: Element | null, razorSourceName: string | null): void {
